...
void fprint_hexstring (FILE *fp, const void *vsrc, size_t len)
{
...
*/
void eprint_hexstring (const void *vsrc, size_t len)
{
	const unsigned char *sp= (const unsigned char *) vsrc;
	size_t i;
	for(i= 0; i< len; ++i) {
...
/*
void eprint_hexstring_nl (const void *src, size_t len)
{
	eprint_hexstring(src, len);
	eprintf("\n");
}
*/
/* Not thread-safe */
